/*
  ...
  2. Adds 10 test locations
  3. Creates active and proposed circuits
*/
...
BEGIN
  ...
  SELECT id INTO company_id FROM companies ORDER BY created_at LIMIT 1;
